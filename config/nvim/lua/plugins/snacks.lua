return {
  ...
  keys = {
    ...
    { "<leader>ef",       function() Snacks.explorer.open() end,                    desc = "Focus Explorer" },
    ...
    { "<leader>sc",       function() Snacks.picker.grep_word() end,                 desc = "Search Word Under Cursor", mode = "n" },
    { "<leader>sC",       function() Snacks.picker.grep_word({ word = false }) end, desc = "Search WORD Under Cursor", mode = "n" },
    { "<leader>sv",       function() Snacks.picker.grep_word() end,                 desc = "Search Visual Selection",  mode = "v" },
    { "<leader>sr",       function() Snacks.picker.resume() end,                    desc = "Resume Last Search" },

    -- Diagnostics and lists
    { "<leader>sd",       function() Snacks.picker.diagnostics_buffer() end,        desc = "Search Diagnostics" },
